...
var flexdropdownmenu = {
    arrowpath: 'http://localhost/prophecy/images/arrowright.gif', //full URL or path to right arrow image
    backarrowpath: 'http://localhost/prophecy/prophecy/images/arrowright.gif', //full URL or path to back arrow image
